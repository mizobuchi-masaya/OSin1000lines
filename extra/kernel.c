...
void user_entry(void) {
    PANIC("not yet implemented");   // 後で実験する
}
*/
...
void yield(void) {
    ...
    // 源氏実行中のプロセス以外に、実行可能なプロセスがない。戻って処理を続行する。
...
struct virtio_virtq *virtq_init(unsigned index) {
    ...
    // 1. Select the queue writing its index (first queue i 0) to QueueSel.
